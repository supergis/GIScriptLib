...
//	SColor = texture2DLod(texture1, vecTexCoord[1].xy, mipLevel2);	
	...
	if(fWIndex < 3.6)
	{
		...
		{
			FColor = texture2DLod(texture2, vecTexCoord[0].xy, mipLevel1);
			SColor = texture2DLod(texture3, vecTexCoord[1].xy, mipLevel2);
		}
	}
	else
	{
		if(fWIndex < 5.6)
		{
			FColor = texture2DLod(texture4, vecTexCoord[0].xy, mipLevel1);
			SColor = texture2DLod(texture5, vecTexCoord[1].xy, mipLevel2);
		}
		else
		{
			FColor = texture2DLod(texture6, vecTexCoord[0].xy, mipLevel1);
			SColor = texture2DLod(texture7, vecTexCoord[1].xy, mipLevel2);
		}
	}
